...
class CodeMaster:
    ...
    JYO_CODES = {
        ...
        "51": "姫路", "54": "高知", "55": "佐賀",
        # 海外
        "A0": "香港", "A2": "アメリカ", "A4": "イギリス", "A6": "フランス",
        "A8": "アイルランド", "B0": "ニュージーランド", "B2": "オーストラリア",
        "B4": "シンガポール", "B6": "スウェーデン", "B8": "マカオ",
        "C0": "ドイツ", "C2": "カナダ", "C4": "イタリア", "C6": "UAE",
    ...
    UMA_KIGO_CODES = {
        ...
        "04": "(市)(地)", "05": "(市)(外)", "06": "父", "07": "市",
        "08": "新", "09": "父市", "10": "父新", "11": "市地",
        "12": "外地", "13": "父地", "14": "父外", "15": "父市地",
    ...
    TRACK_CODES = {
        # 芝
        "10": "芝", "11": "芝・外", "12": "芝・内", "13": "芝・内2周",
        "14": "芝・外2周", "15": "芝・外→内", "16": "芝・内→外",
        "17": "芝・直線", "18": "芝・その他", "19": "芝・2歳",
        # ダート
        "20": "ダート", "21": "ダート・外", "22": "ダート・内",
        "23": "ダート・内2周", "24": "ダート・外2周", "25": "ダート・外→内",
        "26": "ダート・内→外", "27": "ダート・直線", "28": "ダート・その他",
        "29": "ダート・2歳",
        # サンド
        "30": "サンド",
        # 障害
        "51": "障害・芝", "52": "障害・芝ダート", "53": "障害・芝→ダート",
        "54": "障害・ダート→芝→ダート", "55": "障害・芝→ダート→芝",
