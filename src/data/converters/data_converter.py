...
from src.data.models.mykeibadb_models import RaceShosai, KyosobaMaster2, UmagotoRaceJoho, KishuMaster, ChokyoshiMaster
...
class RaceKey:
    ...
    def from_race_id(cls, race_id: str):
        ...
        year = race_id[0:4]
        month_day = race_id[4:8]  # これは使わない（MonthDayは別途格納）
        jyo_cd = race_id[8:10]
        kaiji = race_id[10:12]
