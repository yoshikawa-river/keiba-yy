...
def test_extractor_feature_count_management():
    ...
    try:
        ...
        print(f"✅ JockeyTrainerFeatureExtractor: feature_count = {extractor.feature_count}")
    except Exception as e:
    ...
    try:
        ...
        print(f"✅ PerformanceFeatureExtractor: feature_count = {extractor.feature_count}")
        print(f"   - get_feature_summary method: {'✅' if hasattr(extractor, 'get_feature_summary') else '❌'}")
    except Exception as e:
    ...
    try:
        ...
        print(f"✅ RaceFeatureExtractor: feature_count = {getattr(extractor, 'feature_count', 'N/A')}")
        print(f"   - get_feature_summary method: {'✅' if hasattr(extractor, 'get_feature_summary') else '❌'}")
    except Exception as e:
    ...
    try:
        ...
        print(f"   - get_feature_types method: {'✅' if hasattr(extractor, 'get_feature_types') else '❌'}")
    except Exception as e:
    ...
    try:
        ...
        print(f"✅ ComprehensiveFeaturePipeline: 初期化成功")
        ...
        print(f"   - get_feature_summary: ✅ (total_count: {summary['total_feature_count']})")
