...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name_kana", sa.String(length=100), nullable=True, comment="競馬場名（カナ）"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "mother_father_name", sa.String(length=50), nullable=True, comment="母父馬名"
        ),
        ...
        sa.Column(
            "breeding_farm", sa.String(length=100), nullable=True, comment="生産牧場"
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "name_kana", sa.String(length=100), nullable=True, comment="調教師名（カナ）"
        ),
        sa.Column(
            "belonging", sa.String(length=20), nullable=True, comment="所属 (美浦/栗東)"
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "race_name_sub", sa.String(length=100), nullable=True, comment="レース名（サブ）"
        ),
        sa.Column(
            "grade",
            sa.String(length=10),
        ...
        sa.Column(
            "race_type", sa.String(length=10), nullable=False, comment="トラックタイプ (芝/ダート)"
        ),
        sa.Column("distance", sa.Integer(), nullable=False, comment="距離（メートル）"),
        sa.Column(
            "direction", sa.String(length=10), nullable=True, comment="回り (右/左/直線)"
        ),
        sa.Column("weather", sa.String(length=10), nullable=True, comment="天候"),
        sa.Column(
            "track_condition", sa.String(length=10), nullable=True, comment="馬場状態"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "feature_type", sa.String(length=50), nullable=False, comment="特徴量タイプ"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "odds_value",
            sa.Numeric(precision=8, scale=1),
            nullable=False,
            comment="オッズ値",
        ),
    ...
    op.create_index(
        "idx_race_time", "odds_history", ["race_id", "recorded_at"], unique=False
    )
    op.create_table(
        "predictions",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "model_version", sa.String(length=20), nullable=True, comment="モデルバージョン"
        ),
        sa.Column(
            "prediction_data", sa.JSON(), nullable=False, comment="予測結果の詳細（JSON形式）"
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(["race_id"], ["races.id"], ondelete="CASCADE"),
    ...
    op.create_index(
        "idx_race_model", "predictions", ["race_id", "model_name"], unique=False
    )
    op.create_table(
        "race_entries",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "odds_win", sa.Numeric(precision=6, scale=1), nullable=True, comment="単勝オッズ"
        ),
        sa.Column(
            "odds_place_min",
    ...
    op.create_table(
        ...
        sa.Column(
            "corner_positions", sa.String(length=20), nullable=True, comment="通過順位"
        ),
    ...
    op.create_index(
        "idx_finish_position", "race_results", ["finish_position"], unique=False
    )
